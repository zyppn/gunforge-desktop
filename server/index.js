...
class ArenaRoom extends Room {
  ...
  tryFire(id, p, inp){
    ...
    // f: Exhale. Without it every other player sees a Dragon build fire plain rounds,
    // which is how the local-only tracer work shipped half-done the first time.
  ...
  applyHit(id, p, t, tid, ld, b){
    ...
    /* Juggernaut: a flat 30% reduction, unconditional. It was gated on the target
       FIRING, which measured 4th of 12 at full uptime and 8th - below its own freebuild -
       at 60%. Worse, the condition was invisible: 450ms of tail is under perception and
