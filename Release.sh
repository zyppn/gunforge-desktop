...
echo ""
echo "The release is created already published (draft:false in build.yml) — there is"
echo "nothing to click. What matters is whether the installers uploaded to it:"
echo "  https://github.com/zyppn/gunforge-desktop/releases"
echo ""
echo "NOTE: ./ship.sh does this AND deploys the arena server, and waits for the"
echo "installers. This script only ever did half the job."
